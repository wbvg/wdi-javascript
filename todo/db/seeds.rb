...
t1 = Task.create(:title => 'Get milk', :description => 'Need milk now', :duedate => '3/3/2010', :is_complete => true, :address => '10 Military Rd, Watsons Bay NSW 2030')
t2 = Task.create(:title => 'Get bread', :description => 'No bread at home', :duedate => '1/9/2011', :address => '633 Bourke Street Surry hills NSW 2010')
t3 = Task.create(:title => 'Get laundry', :description => 'Dirty clothes!', :duedate => '5/2/2014', :address => 'Slip Inn/111 Sussex St  Sydney NSW 2000')
